...
type Connection struct {
	...
	onConnStop   func(ziface.IConnection) // 连接级关闭回调
	onConnStart  func(ziface.IConnection) // 连接级关闭回调
}
...
func (c *Connection) SetOnConnStop(f func(ziface.IConnection)) {
	c.onConnStop = f
}
func (c *Connection) SetOnConnStart(f func(ziface.IConnection)) {
	c.onConnStart = f
}
